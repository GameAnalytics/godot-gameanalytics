...
env.Append(CCFLAGS=['-Fios/lib'])
env.Prepend(CXXFLAGS=[
    '-DNEED_LONG_INT', '-DLIBYUV_DISABLE_NEON',
    '-DIPHONE_ENABLED', '-DUNIX_ENABLED', '-DCOREAUDIO_ENABLED'
])
env.Append(LINKFLAGS=["-arch", env['arch'], '-isysroot', sdk_path, '-F' + sdk_path, '-Fios/lib'])
...
# Adding header files
env.Append(CPPPATH=[
    'ios-framework/godot-cpp/include',
    'ios-framework/godot-cpp/include/core',
    'ios-framework/godot-cpp/include/gen',
    'ios-framework/godot-cpp/godot-headers',
    'ios-framework/godot-cpp/godot-headers/main',
    'ios-framework/godot-cpp/godot-headers/core',
    'ios-framework/godot-cpp/godot-headers/core/os',
    'ios-framework/godot-cpp/godot-headers/core/platform',
    'ios-framework/godot-cpp/godot-headers/platform/iphone',
    'ios-framework/godot-cpp/godot-headers/modules',
    'ios-framework/godot-cpp/godot-headers/scene',
    'ios-framework/godot-cpp/godot-headers/servers',
    'ios-framework/godot-cpp/godot-headers/drivers',
    'ios-framework/godot-cpp/godot-headers/thirdparty',
])

# tweak this if you want to use different folders, or more folders, to store your source code in.
sources = Glob('ios-framework/gdnative_ios/src/*.cpp')
sources.append(Glob('ios-framework/gdnative_ios/src/*.mm'))
...
library_name = PLUGIN + "." + library_platform + "." + env["target"] + ".a"
