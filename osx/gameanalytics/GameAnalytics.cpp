...
#elif defined(OSX_PLATFORM) || defined(WINDOWS_PLATFORM) || defined(LINUX_PLATFORM)
    gameanalytics::GameAnalytics::addBusinessEvent(currency.utf8().get_data(), amount, itemType.utf8().get_data(), itemId.utf8().get_data(), cartType.utf8().get_data());
#endif
}
...
#elif defined(OSX_PLATFORM) || defined(WINDOWS_PLATFORM) || defined(LINUX_PLATFORM)
    gameanalytics::GameAnalytics::addResourceEvent((gameanalytics::EGAResourceFlowType)flowType, currency.utf8().get_data(), amount, itemType.utf8().get_data(), itemId.utf8().get_data());
#endif
}
...
void GameAnalytics::addProgressionEvent(const Dictionary &options)
{
    ...
    if(sendScore)
    {
        gameanalytics::GameAnalytics::addProgressionEvent((gameanalytics::EGAProgressionStatus)progressionStatus, progression01.utf8().get_data(), progression02.utf8().get_data(), progression03.utf8().get_data(), score);
    }
    else
    {
        gameanalytics::GameAnalytics::addProgressionEvent((gameanalytics::EGAProgressionStatus)progressionStatus, progression01.utf8().get_data(), progression02.utf8().get_data(), progression03.utf8().get_data());
    }
#endif
}
...
void GameAnalytics::addDesignEvent(const Dictionary &options)
{
    ...
    if(sendValue)
    {
        GameAnalyticsCpp::addDesignEvent(eventId.utf8().get_data(), value);
    }
    else
    {
    ...
    if(sendValue)
    {
        gameanalytics::GameAnalytics::addDesignEvent(eventId.utf8().get_data(), value);
    }
    else
    {
        gameanalytics::GameAnalytics::addDesignEvent(eventId.utf8().get_data());
    }
#endif
}
...
#elif defined(OSX_PLATFORM) || defined(WINDOWS_PLATFORM) || defined(LINUX_PLATFORM)
    gameanalytics::GameAnalytics::addErrorEvent((gameanalytics::EGAErrorSeverity)severity, message.utf8().get_data());
#endif
}
